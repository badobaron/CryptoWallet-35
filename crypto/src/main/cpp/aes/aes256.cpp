...
Aes256::Aes256(const ByteArray &key)
        : m_key(ByteArray(key.size() > KEY_SIZE ? KEY_SIZE : key.size(), 0)),
          m_salt(ByteArray(KEY_SIZE - m_key.size(), 0)), m_rkey(ByteArray(KEY_SIZE, 0)),
          m_buffer_pos(0), m_remainingLength(0), m_decryptInitialized(false) {
...
ByteArray::size_type
Aes256::encrypt(const ByteArray &key, const ByteArray &plain, ByteArray &encrypted) {
    Aes256 aes(key);
...
ByteArray::size_type Aes256::encrypt(const ByteArray &key, const unsigned char *plain,
                                     const ByteArray::size_type plain_length,
                                     ByteArray &encrypted) {
    Aes256 aes(key);
...
ByteArray::size_type
Aes256::decrypt(const ByteArray &key, const ByteArray &encrypted, ByteArray &plain) {
    Aes256 aes(key);
...
ByteArray::size_type Aes256::decrypt(const ByteArray &key, const unsigned char *encrypted,
                                     const ByteArray::size_type encrypted_length,
                                     ByteArray &plain) {
    Aes256 aes(key);
...
ByteArray::size_type
Aes256::encrypt_start(const ByteArray::size_type plain_length, ByteArray &encrypted) {
...
ByteArray::size_type
Aes256::encrypt_continue(const unsigned char *plain, const ByteArray::size_type plain_length,
                         ByteArray &encrypted) {
...
ByteArray::size_type Aes256::decrypt_continue(const unsigned char *encrypted,
                                              const ByteArray::size_type encrypted_length,
                                              ByteArray &plain) {
    ByteArray::size_type i = 0;
